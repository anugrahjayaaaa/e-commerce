<x-admin-layout>
    ...
    <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form id="bulk-action-form" method="POST" action="{{ route('admin.categories.bulk-destroy') }}">
                @csrf
                @method('DELETE')
                    ...
                    <table class="w-full text-left whitespace-nowrap">
                        <thead class="bg-gray-50 text-gray-500 text-xs uppercase font-semibold">
                            <tr>
                                ...
                                <th class="px-6 py-4">
                                    <x-sort-link column="name" label="Category Name" />
                                </th>
                                <th class="px-6 py-4">
                                    <x-sort-link column="slug" label="Slug" />
                                </th>
                                <th class="px-6 py-4">
                                    <x-sort-link column="parent_id" label="Parent" />
                                </th>
                                <th class="px-6 py-4">
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p class="text-sm mt-1">You haven't added any categories to your store yet.
                                            </p>
                                            <a href="{{ route('admin.categories.create') }}"
