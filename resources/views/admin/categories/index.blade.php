        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <table class="w-full text-left whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div
                                    class="w-10 h-10 bg-gray-100 rounded flex items-center justify-center text-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="bg-purple-50 text-purple-700 px-2 py-1 rounded text-xs font-semibold">1,240</span>
                            </td>
                            <td class="px-6 py-4">
                                <span
            ...
            <div
                ...
                <span class="text-sm text-gray-500">Showing <span class="font-bold text-gray-700">1-4</span> of <span
                        class="font-bold text-gray-700">18</span> categories</span>
