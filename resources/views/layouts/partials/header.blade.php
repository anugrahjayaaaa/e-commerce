                ...
                <div class="relative group">
                    ...
                    <ul
                        ...
                        @guest
                            ...
                            <li>
                                <a href="{{ route('register') }}" class="block px-4 py-2 hover:bg-gray-100 text-sm">Register</a>
                            </li>
                        @else
                            <li>
                                <a href="{{ Auth::user()->utype == 'ADM' ? route('admin.index') : route('users.index') }}"
            ...
            <div class="flex items-center space-x-5">
                ...
                <div class="relative">
                    ...
                    <ul id="avatar-submenu-mobile"
                        ...
                        <li><a href="my-account.php" class="block px-4 py-2 hover:bg-gray-100 text-sm text-gray-700">My
                                Account</a></li>
